<div class="container mt-4">
    ...
    <p>Modifique los datos del cliente seleccionado.</p>

    <form action="index.php?controller=clientes&action=actualizar" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" 
                ...
                id="dui" 
                name="dui" 
                value="<?php echo htmlspecialchars($cliente['DuiCliente'] ?? ''); ?>"
                required 
                maxlength="10" 
                pattern="[0-9]{8}-[0-9]"
        ...
        <div class="mb-3">
            ...
            <input type="email" 
                ...
                id="correo" 
                name="correo" 
                value="<?php echo htmlspecialchars($cliente['CorreoCliente'] ?? ''); ?>"
                required 
                maxlength="100" 
        ...
        <div class="mb-3">
            ...
            <input type="tel" 
                ...
                id="telefono" 
                name="telefono" 
                value="<?php echo htmlspecialchars($cliente['TelefonoCliente'] ?? ''); ?>"
                maxlength="15" 
                pattern="[0-9]{8,15}"
