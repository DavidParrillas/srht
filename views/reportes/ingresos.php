...
<div class="table-responsive">
    <table class="table table-hover table-striped">
        ...
        <tbody>
            <?php if (empty($datos)): ?>
                <tr>
                    <td colspan="4" class="text-center">No se encontraron ingresos para el período seleccionado.</td>
                </tr>
            <?php else: ?>
                <?php foreach ($datos as $fila): ?>
                    <tr>
                        <td><?php echo htmlspecialchars($fila['NombrePaquete']); ?></td>
                        <td><?php echo htmlspecialchars($fila['FormaPago']); ?></td>
                        <td><?php echo htmlspecialchars($fila['NumeroPagos']); ?></td>
                        <td>$<?php echo number_format($fila['TotalIngresos'], 2); ?></td>
                    </tr>
                <?php endforeach; ?>
            <?php endif; ?>
        </tbody>
